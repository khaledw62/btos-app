...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.maxScrollExtent == scrollController.offset && controller.next.value != null) {
        controller.getPropertiesListing(isFull: true);
      }
    });
    super.initState();
  }
        ...
        children: [
          ...
          GetX<PropertiesListingController>(
            ...
            builder: (controller) {
              return Column(
                children: [
                  ...controller.propertiesListing.value
                      .map(
                        (e) => PropertyCard(property: e),
                      )
                      .toList(),
                  if (controller.next.value != null) Padding(
                    padding: const EdgeInsets.symmetric(vertical: 20.0),
                    child: DefaultSpinCircleLoader(),
                  )
                ],
              );
            },
